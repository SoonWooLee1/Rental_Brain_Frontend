...
/** 제품 연체 처리 권한 */
const canProcessItemOverdue = computed(() =>
...
<template>
    <div class="detail-page" v-loading="loading">
        ...
        <div class="summary">
            ...
            <!-- 권한 없음 -->
            <el-tooltip v-if="detail?.status === 'P' && !canProcessItemOverdue" content="제품 연체 처리 권한이 없습니다"
                placement="top">
                <span>
            ...
            <!-- 권한 있음 -->
            <el-button v-else-if="editable" type="primary" @click="saveCount">
                수정 저장
            </el-button>
        </div>
        ...
        <el-descriptions :column="2" border class="desc-box">
            ...
            <el-descriptions-item label="연체 수량">
                <el-input-number v-if="editable" v-model="editCount" :min="0" />
